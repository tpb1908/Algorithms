 ...
 */
public class QuickSelect implements Test {
     ...
     */
    public double select(double[] data, int n) {
        int left = 0;
    ...
    public int partition(double[] data, int left, int right, int pivot) {
    ...
    public void swap(double[] data, int p1, int p2) {
        double c = data[p1];
        data[p1] = data[p2];
        data[p2] = c;
    }
